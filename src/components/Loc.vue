          ...
          <div class="Reveal-search-content">
            <div class="row">
              ...
              <div class="col-lg-3 col-md-3 col-sm-6">
                <div class="form-group">
                  <div class="input-with-icon">
                    <select id="list-category1" class="form-control">
                      <option value="">&nbsp;</option>
              ...
              <div class="col-lg-3 col-md-3 col-sm-6">
                <div class="form-group">
                  <div class="input-with-icon">
                    <select id="list-category2" class="form-control">
                      <option value="">&nbsp;</option>
              ...
              <div class="col-lg-3 col-md-3 col-sm-6">
                <div class="form-group">
                  <div class="input-with-icon">
                    <select id="list-category3" class="form-control">
                      <option value="">&nbsp;</option>
              ...
              <div class="col-lg-3 col-md-3 col-sm-6">
                <div class="form-group">
                  <div class="input-with-icon">
                    <select id="list-category4" class="form-control">
                      <option value="">&nbsp;</option>
                      <option value="1">Oba Akran</option>
                      <option value="2">Restaurants</option>
                      <option value="3">Hotels</option>
                      <option value="4">Educations</option>
                      <option value="5">Business</option>
...
.gray-bg {
  /* background:#f7f9fc url(../assets/image/img/pattern.png); */
...
.Reveal-grid-wrapper.style-2
  .Reveal-grid-caption-header
  .Reveal-header-title
  a {
  color: #ffffff;
}
...
.inc-fleat.inc-add:before {
  background: url(../assets/images/img/add.svg);
  content: "";
  position: absolute;
...
.inc-fleat.inc-call:before {
  background: url(../assets/images/img/call.svg);
  content: "";
  position: absolute;
  background-size: contain;
  width: 23px;
...
.Reveal-items-modern-list .inc-fleat.inc-add:before {
  /* background:url(../assets/images/img/light-add.svg); */
  content: "";
  position: absolute;
  background-size: contain;
  width: 23px;
...
.Reveal-items-modern-list .inc-fleat.inc-call:before {
  /* background: url(../assets/images/img/light-call.svg); */
  content: "";
  position: absolute;
  background-size: contain;
  width: 23px;
...
.inc-fleat.inc-bed:before {
  /* background:url(../assets/images/img/bed.svg); */
  content: "";
  position: absolute;
  background-size: contain;
  width: 25px;
...
.inc-fleat.inc-bath:before {
  /* background:url(../assets/images/img/bath.svg); */
  content: "";
  position: absolute;
  background-size: contain;
  width: 25px;
...
.inc-fleat.inc-type:before {
  background: url(../assets/images/img/type.svg);
  content: "";
  position: absolute;
  background-size: contain;
  width: 25px;
...
.inc-fleat.inc-area:before {
  /* background:url(../assets/images/img/area.svg); */
  content: "";
  position: absolute;
  background-size: contain;
  width: 25px;
...
.title__curve {
  width: 100%;
  height: 60px;
  background-image: url(../assets/images/img/course-title-curve.png);
  background-repeat: no-repeat;
...
.Reveal-icon-wrap:before {
  content: url(../assets/images/img/arrow.png);
  position: absolute;
  width: auto;
  height: auto;
  background: transparent;
